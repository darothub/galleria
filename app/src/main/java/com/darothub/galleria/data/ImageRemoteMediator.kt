...
class ImageRemoteMediator(
    ...
    private suspend fun getKeyPageData(loadType: LoadType, state: PagingState<Int, ImageDetails>): Any {
    ...
    private suspend fun getRemoteKeyForLastItem(state: PagingState<Int, ImageDetails>): RemoteKeys? {
